...
<div class="datenschutz">
    ...
    <p>
      ...
      Dessen Kontaktdaten können Sie dem Abschnitt &bdquo;Hinweis zur Verantwortlichen Stelle&ldquo; in dieser Datenschutzerklärung entnehmen.
    </p>
    ...
    <p>
      ...
      Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TDDDG umfasst.
    ...
    <p>
      ...
      Sofern Sie in die Speicherung von Cookies oder in den Zugriff auf Informationen in Ihr Endgerät (z.&nbsp;B. via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.
    ...
    <p>
      ...
      Eine verschlüsselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von &bdquo;http://&ldquo; auf &bdquo;https://&ldquo; wechselt und an dem Schloss-Symbol in Ihrer Browserzeile.
    </p>
    <p>
    ...
    <p>
      ...
      Zwingende gesetzliche Bestimmungen &ndash; insbesondere gesetzliche Aufbewahrungsfristen &ndash; bleiben unberührt.
    </p>
    <h2>5. Plugins und Tools</h2>
    <h3>Font Awesome (lokales Hosting)</h3>
    <p>
      Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten Font Awesome.
      Font Awesome ist lokal installiert.
    ...
    <h3>Github Pages</h3>
    <p>
      Diese Webseite nutzt Github Pages zur statischen Bereitstellung der Webseite.
    </p>
    <p>
      Weitere Informationen zu <a href="https://pages.github.com/" target="_blank" rel="noopener noreferrer">Github Pages</a> finden Sie in der Datenschutzerklärung für Github Pages unter: <a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noopener noreferrer">https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement</a>.
    </p>
    <h3>Academicons</h3>
    <p>
      Diese Webseite nutzt Academicons zur Darstellung akademischer Anbieter.
      Academicons ist lokal installiert und eine Verbindung zu JSDelivr CDN Servern findet nicht statt.
      Alle Produktnamen, Logos und Marken sind das Eigentum ihrer jeweiligen Inhaber.
      Die Verwendung dieser Namen, Logos und Marken bedeutet nicht, dass diese unterstützt werden.
    </p>
    <p>
      Witer Infromationen zu <a href="https://jpswalsh.github.io/academicons/" target="_blank" rel="noopener noreferrer">Academicons</a> finden Sie hier:  <a href="https://jpswalsh.github.io/academicons/" target="_blank" rel="noopener noreferrer">https://jpswalsh.github.io/academicons/</a>
    </p>
    <p>
      Quelle: <a href="https://www.e-recht24.de">https://www.e-recht24.de</a> sowie zusätzliche private Änderungen.
    </p>
</div>
